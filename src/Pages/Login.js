      ...
      <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div>
          ...
          <div class="mt-2">
            ...
            <input
              value={regHandleId}
              onChange={(e) => setregHandleId(e.target.value)}
              id="handleId" name="handleId" type="text" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
            ...
            <div>
              ...
              <div class="mt-2">
                ...
                <input
                  ...
                  id="userName" name="userName" type="text" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            <div>
              <label for="userName" class="block text-sm font-medium leading-6 text-gray-900">Email Id</label>
              <div class="mt-2">
...
// note: createUserWithEmailAndPassword() ctrate a user account and logs him in for the entire project.

// note : signInWithEmailAndPassword() logs user in for the entire project